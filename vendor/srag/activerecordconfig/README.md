...
namespace srag\Plugins\X\Config
//...
use srag\ActiveRecordConfig\SrPluginInfosFetcher\ActiveRecordConfigTableGUI;
//...
...
if (\srag\DIC\SrPluginInfosFetcher\DICStatic::dic()->database()->tableExists(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME)) {
    ...
    \srag\DIC\SrPluginInfosFetcher\DICStatic::dic()->database()->dropTable(\srag\Plugins\X\Config\ConfigOld::TABLE_NAME);
}
?>
```
