...
```php
...
use srag\ActiveRecordConfig\SrPluginInfosFetcher\x\Utils\ConfigTrait;
...
class x {
...
use ConfigTrait;
...
<#x>
<?php
\srag\ActiveRecordConfig\SrPluginInfosFetcher\x\Repository::getInstance()->installTables();
?>
```
