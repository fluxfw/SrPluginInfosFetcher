...
```php
//...
use srag\RemovePluginDataConfirm\SrPluginInfosFetcher\x\PluginUninstallTrait;
//...
...
```php
//...
use srag\RemovePluginDataConfirm\SrPluginInfosFetcher\x\RepositoryObjectPluginUninstallTrait;
//...
