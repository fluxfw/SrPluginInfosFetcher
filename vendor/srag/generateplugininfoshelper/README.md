...
```php
...
use srag\GeneratePluginInfosHelper\SrPluginInfosFetcher\x\GeneratePluginPhpAndXml; 
...
...
```php
...
use srag\GeneratePluginInfosHelper\SrPluginInfosFetcher\x\GeneratePluginReadme; 
...
...
```json
  ...
  "update-version": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrPluginInfosFetcher\\x\\UpdateVersion::updateVersion"
    ]
  ...
```
...
```php
...
use srag\GeneratePluginInfosHelper\SrPluginInfosFetcher\x\UpdateVersion; 
...
